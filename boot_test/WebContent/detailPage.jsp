...
<%@ page import="com.lecture.finalproject.model.ModelLocation"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
   ...
   <jsp:setProperty property="*" name="model" />
			...
			<div class="nav-container">
				<div class="nav">
					<ul>
						...
						<li><button id="visit-btn" type="button" class="btn btn-default navBtn" ><span class="glyphicon glyphicon-pushpin"><span class="visit"> 다녀온 여행지 등록</span></button></span></li>
	...
	<%
		...
		int visitStateTemp = (Integer)request.getAttribute("visitState");
		
		ModelLocation modelLocation = (ModelLocation)request.getAttribute("locationObject");
